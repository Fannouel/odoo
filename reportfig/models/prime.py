...
class Prime(models.Model):
    ...
    prime_amount = fields.Float(string='Prime(Ar)', compute='_compute_prime', store=True)
    sbh = fields.Float(string='Salaire de base par heure (Ar)', compute='_compute_sbh', store=True)
